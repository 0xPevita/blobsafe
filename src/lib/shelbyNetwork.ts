...
export const SHELBY_NETWORK_CONFIG: Record<ShelbyNetworkName, {
  ...
  shelbynet: {
    ...
    indexerUrl: "https://api.shelbynet.aptoslabs.com/nocode/v1/public/alias/shelby/shelbynet/v1/graphql",
  ...
  testnet: {
    ...
    indexerUrl: "https://api.testnet.aptoslabs.com/nocode/v1/public/alias/shelby/testnet/v1/graphql",
